...
class PembangunanembungdanairController extends Controller
{
    // Menampilkan form untuk input
    public function create()
    {
        return view('SumberDayaAir.Penampunganembungdanair.Create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('Pembangunan-embung-dan-air.index')->with('success', 'Data berhasil Disimpan');
    }
    ...
    public function index()
    {
        ...
        $data = Master::where('jenis_surat', 'Pembangunan Embung dan Penampung Air Lainnya')->get();
        
    
        return view('SumberDayaAir.Penampunganembungdanair.Index', compact('data'));
    }
    ...
    public function edit($id, $key)
    {
        ...
        return view('SumberDayaAir.Penampunganembungdanair.Edit', compact(
    ...
    public function update(Request $request, $id, $key)
    {
        ...
        return redirect()->route('Pembangunan-embung-dan-air.index')->with('success', 'Data berhasil diperbarui');
    }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        return redirect()->route('Pembangunan-embung-dan-air.index')->with('success', 'Data berhasil dihapus');
    }
}
