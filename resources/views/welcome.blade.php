...
<h5 style="color: #000000; margin-top: 5px; font-weight: 500; text-align: center; font-size: 1.1rem;">
     Inovasi ELLA
</h5>
						...
						<li class="dropdown user user-menu">
							...
							<ul class="dropdown-menu animated flipInX">
								<li class="user-body">
									...
									<form id="logout-form" asp-controller="Login" asp-action="Logout" method="post" class="d-none"></form>
								</li>
							</ul>
						</li>
            ...
            <ul class="sidebar-menu" data-widget="tree">	
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/ProgramSDA"><i class="fas fa-water"></i> Program Sumber Daya Air</a></li>
				...
				<li>
					<a href="/master">
						<i class="fas fa-database"></i> <!-- Ganti dengan ikon yang lebih sesuai -->
